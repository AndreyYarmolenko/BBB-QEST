function statusOrg(id, rights) {
    ...
    model_data = ['id', 'name', 'title', 'boss_func', 'department', 'boss_ad', 'ft_pt', 'active'];
    columns_data = [
                        ...
                        items: [
		                    ...
		                    },
		                    {
		                        ...
		                        handler: function(){
		                            ...
		                            Ext.Ajax.request({
		                                url: 'scripts/reports/export_reports_excel.php?exportOrg=true',
		                                method: 'POST',
		                               	params: {
                                            dataStore: convertStore(data_store) 
		                                },
		                                success: function(response) {
                                            if(response.responseText == "Not value!") Ext.MessageBox.alert(lan.error, lan.no_data);
                                                ...
                                                var data = JSON.parse(response.responseText);
    		                                    if(data.success) {
    		                                        var downloadUrl = 'scripts/reports/export_reports_excel.php?downloadOrg=true';
		                    ...
		                    },
		                    {
		                    	...
		                    	handler: function() {
		                            Ext.Ajax.request({
		                                url: 'scripts/reports/export_reports_pdf.php?exportOrgPdf=true',
		                                method: 'POST',
		                               	params: {
		                                    dataStore: convertStore(data_store)
		                                },
		                                success: function(response) {
                                            if(response.responseText == "Not value!") Ext.MessageBox.alert(lan.error, lan.no_data);
                                                ...
                                                var data = JSON.parse(response.responseText);
    		                                    if(data.success) {
    		                                        location.href = 'scripts/reports/export_reports_pdf.php?downloadOrgStatus=true';
    		                                    }
                                            }		                                    
		                                },
		                                failure: function(response) {		                                    
